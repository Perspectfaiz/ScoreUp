...
export function Qnform({ data, page, setPage, secIndex, onDelete }) {

    // Ensures if "options" array has 4 values
                ...
                <div className={styles.top}>
                    <div className={styles.qninfo}>
                        ...
                        <button className={styles.deletebtn} onClick={() => {
                            const assure = confirm("Are you sure you want to delete this Question?");
                            if(assure) {
                                onDelete(secIndex, data.index)
                            }
                        }}>
                            <RiDeleteBin7Line/>
                        </button>
